//
//  AnimationFavoriteButton.swift
//  NanoIndividual
//
//  Created by Helaine Pontes on 09/02/21.
...
@IBDesignable
public class Animation: UIButton {
    ...
    fileprivate func addTargets() {
        ...
        // add target
        //===============
        self.addTarget(self, action: #selector(Animation.touchDown(_:)), for: UIControl.Event.touchDown)
        self.addTarget(self, action: #selector(Animation.touchUpInside(_:)), for: UIControl.Event.touchUpInside)
        self.addTarget(self, action: #selector(Animation.touchDragExit(_:)), for: UIControl.Event.touchDragExit)
        self.addTarget(self, action: #selector(Animation.touchDragEnter(_:)), for: UIControl.Event.touchDragEnter)
        self.addTarget(self, action: #selector(Animation.touchCancel(_:)), for: UIControl.Event.touchCancel)
    }

    @objc func touchDown(_ sender: Animation) {
        self.layer.opacity = 0.4
    }
    @objc func touchUpInside(_ sender: Animation) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragExit(_ sender: Animation) {
        self.layer.opacity = 1.0
    }
    @objc func touchDragEnter(_ sender: Animation) {
        self.layer.opacity = 0.4
    }
    @objc func touchCancel(_ sender: Animation) {
        self.layer.opacity = 1.0
    }
